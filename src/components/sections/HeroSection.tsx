    ...
    <section id="hero" className="snap-section min-h-screen bg-primary-dark relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center min-h-screen px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="w-full max-w-4xl sm:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto">
          ...
          <div
            className="text-center sm:text-left flex flex-col items-center sm:flex-row sm:justify-start sm:items-center gap-y-2 gap-x-6 sm:gap-y-0 sm:gap-x-8 md:gap-x-16 lg:gap-x-20 xl:gap-x-24 opacity-75"
          >
            {/* Burger layout for mobile: grid with 3 rows */}
            <div className="w-full flex flex-col items-center sm:flex-row sm:items-center sm:w-auto">
          ...
          <div className={`${spacingClasses.titleSpacing} my-5`}>
            <button 
