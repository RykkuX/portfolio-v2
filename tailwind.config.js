  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        // About Me compact scale - perfect for resume/CV layouts
        'aboutme-h1': ['20px', { lineHeight: '30px', letterSpacing: '-0.1px', fontWeight: '700' }],
        'aboutme-h2': ['17px', { lineHeight: '26px', letterSpacing: '0.1px', fontWeight: '700' }],
        'aboutme-h3': ['15px', { lineHeight: '23px', letterSpacing: '0.1px', fontWeight: '700' }],
        'aboutme-h4': ['13px', { lineHeight: '21px', letterSpacing: '0.1px', fontWeight: '700' }],
        'aboutme-h5': ['12px', { lineHeight: '19px', letterSpacing: '0.1px', fontWeight: '700' }],
        'aboutme-h6': ['10px', { lineHeight: '16px', letterSpacing: '0.2px', fontWeight: '700' }],
        'aboutme-h7': ['9px', { lineHeight: '15px', letterSpacing: '0.2px', fontWeight: '700' }],
        'aboutme-body-lg': ['9px', { lineHeight: '14px', letterSpacing: '0.2px', fontWeight: '400' }],
        'aboutme-body': ['14px', { lineHeight: '22px', letterSpacing: '0.1px', fontWeight: '400' }],
        'aboutme-link': ['8px', { lineHeight: '13px', letterSpacing: '0.2px', fontWeight: '400' }],
        'aboutme-caption': ['6px', { lineHeight: '10px', letterSpacing: '0.1px', fontWeight: '400' }],
      },
    },
  },
  plugins: [],
